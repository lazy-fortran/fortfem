...
| Isogeometric FEEC | Nonuniform open B-spline evaluation and analytical derivatives; exact coefficient derivative maps; and the 2D tensor-product H1--H(curl)--L2 de Rham incidence complex with a nonuniform-knot analytical polynomial-reproduction oracle | Rational geometry maps, physical Piola pullbacks, 3D H1--H(curl)--H(div)--L2 spaces, sparse weak-form assembly, multipatch conformity, and JOREK's poloidal Bézier/Fourier operator suite |
