...
| Isogeometric FEEC | Nonuniform open B-spline evaluation and analytical derivatives; exact coefficient derivative maps; and 2D H1--H(curl)--L2 and 3D H1--H(curl)--H(div)--L2 tensor-product de Rham incidence complexes with nonuniform-knot analytical polynomial-reproduction and exact-sequence oracles | Rational geometry maps, physical Piola pullbacks, sparse weak-form assembly, multipatch conformity, and JOREK's poloidal Bézier/Fourier operator suite |
