...
| Perfectly matched layers | Transformation-consistent Cartesian scalar and curl-curl tensors; executable P1 scalar Helmholtz slab and triangular 2D solver with FortSparse; arbitrary-order tetrahedral Nedelec curl-curl PML element kernels, orientation-aware complex FortSparse assembly, and prescribed-tangential-DOF solves; polynomial complex stretch, exact stretched-coordinate convergence, and predicted-reflection oracles | Geometry-layer generation and physical Maxwell reflection benchmarks |
