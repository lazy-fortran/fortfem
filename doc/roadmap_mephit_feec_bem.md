...
The current implementation baseline is FortFEM `6ad49b4` with 201 passing
...
| Arbitrary-order 2D FEEC | Triangle H1, first/second-kind H(curl), RT/BDM H(div), and DG through order four, with orientations, commuting projections, sparse assembly, convergence tests, public symbolic first-kind H(curl) solves through order four, and public symbolic RT0–RT3 and BDM1–BDM4 H(div) solves | Exhaustive mixed solves above RT1-DG1 |
...
cell moments. General mixed high-level PDE solves remain absent.
