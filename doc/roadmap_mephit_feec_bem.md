...
| Isogeometric FEEC | Nonuniform open B-spline evaluation and analytical derivatives; exact coefficient derivative maps; 2D H1--H(curl)--L2 and 3D H1--H(curl)--H(div)--L2 tensor-product de Rham incidence complexes; and rational tensor-product surface geometry with analytical Jacobians, covered by nonuniform-knot polynomial-reproduction, exact-sequence, and affine-map oracles | Physical Piola pullbacks, sparse weak-form assembly, multipatch conformity, and JOREK's poloidal Bézier/Fourier operator suite |
