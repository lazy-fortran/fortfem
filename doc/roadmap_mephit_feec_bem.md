...
| Perfectly matched layers | Transformation-consistent Cartesian scalar and curl-curl tensors; executable P1 scalar Helmholtz slab with polynomial complex stretch, exact stretched-coordinate convergence, and predicted-reflection oracle | Multidimensional PML assembly and geometry-layer generation |
