...
The current implementation baseline is FortFEM `207a5ce` with 198 passing
...
General mixed high-level PDE solves and higher-order high-level solver
dispatch remain absent.
