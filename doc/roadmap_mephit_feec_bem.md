...
| Isogeometric FEEC | Nonuniform open B-spline evaluation and analytical derivatives; exact coefficient derivative maps; 2D H1--H(curl)--L2 and 3D H1--H(curl)--H(div)--L2 tensor-product de Rham incidence complexes; rational tensor-product surface geometry with analytical Jacobians; and covariant H1/H(curl), contravariant H(div), and determinant-scaled L2 physical pullbacks, covered by nonuniform-knot polynomial-reproduction, exact-sequence, affine-map, and invariant-pairing oracles | Sparse weak-form assembly, rational volume geometry, multipatch conformity, and JOREK's poloidal Bézier/Fourier operator suite |
