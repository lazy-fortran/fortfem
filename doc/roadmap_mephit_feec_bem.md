...
| Perfectly matched layers | Transformation-consistent Cartesian scalar and curl-curl tensors; executable P1 scalar Helmholtz slab and triangular 2D solver with FortSparse; arbitrary-order tetrahedral Nedelec curl-curl PML element kernels and orientation-aware complex FortSparse assembly; polynomial complex stretch, exact stretched-coordinate convergence, and predicted-reflection oracles | Executable curl-curl PML boundary-value solve and geometry-layer generation |
