---
title: sheet_current_surface_gallery Example
---

# sheet_current_surface_gallery Example
...
```bash
fpm run --example sheet_current_surface_gallery
```
...
![primary.png](../../media/examples/sheet_current_surface_gallery/primary.png)

### surface_current_solutions_cylinder_3d.png

![surface_current_solutions_cylinder_3d.png](../../media/examples/sheet_current_surface_gallery/surface_current_solutions_cylinder_3d.png)

### surface_current_solutions_slab_3d.png

![surface_current_solutions_slab_3d.png](../../media/examples/sheet_current_surface_gallery/surface_current_solutions_slab_3d.png)

### surface_current_solutions_sphere_3d.png

![surface_current_solutions_sphere_3d.png](../../media/examples/sheet_current_surface_gallery/surface_current_solutions_sphere_3d.png)

### surface_current_solutions_torus_3d.png

![surface_current_solutions_torus_3d.png](../../media/examples/sheet_current_surface_gallery/surface_current_solutions_torus_3d.png)
