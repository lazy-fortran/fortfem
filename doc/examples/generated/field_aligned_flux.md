---
title: field_aligned_flux Example
---

# field_aligned_flux Example
...
```bash
fpm run --example field_aligned_flux
```
...
![field_aligned_flux_components_1d.png](../../media/examples/field_aligned_flux/field_aligned_flux_components_1d.png)
