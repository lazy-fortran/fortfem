! Extracted from src/generated/fortfem_helmholtz_bem_smooth_products.f90 by
...
pure subroutine generated_helmholtz_single_layer_smooth_integrand(first_point_1, first_point_2, &
...
end subroutine generated_helmholtz_single_layer_smooth_integrand
