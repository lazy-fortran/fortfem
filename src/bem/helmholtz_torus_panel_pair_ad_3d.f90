module fortfem_helmholtz_torus_panel_pair_ad_3d
...
contains
    ...
    subroutine integrate_helmholtz_torus_panel_p0_3d( &
        ...
        status = 0
    end subroutine integrate_helmholtz_torus_panel_p0_3d

    subroutine integrate_helmholtz_torus_panel_p0_3d_jvp( &
            first_parameters, second_parameters, major_radius, minor_radius, &
        ...
        status = 0
    end subroutine integrate_helmholtz_torus_panel_p0_3d_jvp

    subroutine integrate_helmholtz_torus_panel_p0_3d_vjp( &
            first_parameters, second_parameters, major_radius, minor_radius, &
        ...
        real(dp) :: first_tangent_xi(3), first_tangent_eta(3)
        real(dp) :: second_tangent_xi(3), second_tangent_eta(3)
        real(dp) :: local_wave_number_bar, xi_bar, eta_bar
        integer :: first_node, quadrature_status, second_node
        ...
        status = 0
    end subroutine integrate_helmholtz_torus_panel_p0_3d_vjp

end module fortfem_helmholtz_torus_panel_pair_ad_3d
