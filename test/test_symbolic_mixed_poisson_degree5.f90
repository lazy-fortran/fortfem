program test_symbolic_mixed_poisson_degree5
    ...
    use fortfem_api, only: &
        compile_mixed_form_csc, div, dx, function_space, function_space_t, &
        init_measures, inner, mesh_t, operator(*), rectangle_mesh, &
        solve_symbolic_mixed_poisson_rt, test_function, test_function_t, &
        trial_function, trial_function_t, vector_function_space, &
