program test_cdt_segments_debug
    use fortfem_kinds
    use delaunay_types
    ...
    write(*,*) "=== CDT 4-Point with Segments Debug ==="
    ...
    write(*,*) "Calling constrained_delaunay_triangulate with boundary..."
...
end program test_cdt_segments_debug
