...
mortar, torus-vector, four-geometry sheet-current, TEAM provenance, and
solution-first documentation slices and regenerated the inventory in
`c7a40fd`; future agents must take the next disjoint example batch rather than
reopening these files or duplicating their exports.
