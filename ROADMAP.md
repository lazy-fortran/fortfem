...
| FEEC | Oriented triangular and tetrahedral H1, H(curl), H(div), and DG families, Piola maps, commuting tests, sparse assembly, mixed RT-DG Poisson, neutral real and complex two-field/packed N-field block graph residuals with complete JVP/VJP contracts, and real/complex packed-graph CSC adapters for retained FortSparse factors | Retained-factor JVP/VJP composition over N-field graphs, Schur/field-split derivatives, and arbitrary multipatch assembly |
