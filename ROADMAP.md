...
- **API-04 — generated visibility complete:**
  ...
  checker.
- **API-05 — first migration slices complete:** seventeen representative examples
  ...
  the 3-D tree--cotree solution gallery, and the field-aligned anisotropic
  3-D solution through canonical capability surfaces.
