...
boundary-DtN consumer slices landed in `4a11fff`, `a0547d1`, and `69881fc`.
They move the remaining representative curl--curl solution client to
...
clients to `fortfem_boundary`, with no implementation or duplicate exports.
