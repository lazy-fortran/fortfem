...
| FEEC | Oriented triangular and tetrahedral H1, H(curl), H(div), and DG families, Piola maps, commuting tests, sparse assembly, mixed RT-DG Poisson, neutral real and complex two-field/packed N-field block graph residuals with complete JVP/VJP contracts | N-field sparse block graphs with retained factors, Schur/field-split derivatives, and arbitrary multipatch assembly |
