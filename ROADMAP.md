...
- The neutral `linear_response_interchange_t` record now defines the external
  ...
  (K-\omega^2M+i\omega R+V+W) has independent complex JVP/VJP products and
  a manufactured adjoint oracle. GPEC, MARS-F, GLISS, STARWALL readers,
