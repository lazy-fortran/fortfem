...
| PML | Scalar and curl-curl Cartesian complex-stretching tensors with slab, triangular, and tetrahedral examples, plus full complex 3-by-3 curvilinear scalar and curl-curl coefficient maps, tetrahedral Nédélec element and merged CSC JVP/VJP products with diagonal-reduction oracles | Automated curved-object layers, reflection/error metrics, and derivative coverage for all geometry parameters |
...
- Global curvilinear tetrahedral PML CSC value/JVP/VJP assembly is now public.
  ...
  complex adjoint. Curvilinear solved-state products and curved-object
  reflection metrics remain follow-up work.
